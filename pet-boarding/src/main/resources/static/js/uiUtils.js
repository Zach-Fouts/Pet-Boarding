...
function openConfimationDialog(message, actionHref) {
  addConfirmationDialog();
  document.getElementById('genericConfirmationDialog').text = message;
  document
    .getElementById('btnGenericConfirmationDialog')
    .setAttribute('href', actionHref);
    ...
    let dialogFragment = document.createRange().createContextualFragment(`
        <div class="modal" id="genericConfirmationDialog" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content">
                    <div class="modal-body">
                        <p id="genericConfirmationMessage">
                            messagee?
                        </p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm  btn-secondary" data-bs-dismiss="modal">Cancel</button>
                        <a id="btnGenericConfirmationAccept" class="btn btn-sm btn-primary" data-bs-dismiss="modal">Continue</a>
                    </div>
                </div>
            </div>
        </div>
