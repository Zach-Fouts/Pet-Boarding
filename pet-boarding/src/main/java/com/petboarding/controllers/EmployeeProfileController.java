...
public class EmployeeProfileController extends AppBaseController{
    ...
    public String processUpdateEmployeeRequest(
            ...
            @RequestParam(value = "image", required = false) MultipartFile multipartFile, HttpSession httpSession) throws IOException {
        if(errors.hasErrors()) {
        ...
        httpSession.setAttribute("user", employee.getUser());
